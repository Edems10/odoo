...
class CourseConstants:
    ...
    class Messages:
        ...
        TEACHER_CANNOT_ENROLL: Final[str] = "Teachers cannot enroll in their own courses."
        ...
        COURSE_NOT_ACCEPTING: Final[str] = "This course is not currently accepting enrollments."
        NEGATIVE_PRICE_ERROR: Final[str] = "Course price cannot be negative."
        CANNOT_PUBLISH_NEGATIVE: Final[str] = "Cannot publish course with negative price."
